    ...
    <div className="container page">
      <div className="surface section">
        ...
        <div className="prose">
          ...
          <h3>2. Our Privacy Principles</h3>
          <p>We design our apps with privacy-first principles, meaning:</p>
          <ul>
            <li>We collect only what is necessary</li>
            <li>We avoid personal data wherever possible</li>
            <li>We do not sell user data</li>
            <li>We do not build advertising profiles</li>
            <li>We comply with Google Play policies, child safety rules, and data minimisation standards</li>
          </ul>
          ...
          <ul>
            ...
            <li>Support messages or feedback you voluntarily submit</li>
          </ul>
          <p>This information is used only to respond to your request.</p>

          <p><strong>b) Automatically Collected Information</strong></p>
          <p>Some apps may collect limited, non-identifiable technical data, such as:</p>
          <ul>
          ...
          <ul>
            <li>Names or real-world identity details</li>
            <li>Phone numbers or addresses</li>
            <li>Precise GPS location</li>
            <li>Contacts, photos, or media files</li>
            <li>Religious, political, or health profiling</li>
          ...
          <ul>
            ...
            <li>No user-generated content is allowed</li>
            <li>We follow Google Play’s Families and Children policies where required</li>
          </ul>

          <h3>7. Third-Party Services</h3>
          <p>Our apps may rely on trusted platform services such as:</p>
          <ul>
            <li>Google Play Console (distribution, crash reporting, performance metrics)</li>
          ...
          <p>We will respond to valid requests in a reasonable timeframe.</p>

          <h3>11. Changes to This Policy</h3>
          <p>
            We may update this Privacy Policy as our apps evolve. Updates will be posted on this page with a revised date.
          </p>
